...
# aerotools
# Copied from https://github.com/acrovato/gmshcfd/blob/adri/run.py
...
def main():
    ...
    print("""     ___       _______ .______        ______      .___________.  ______     ______    __          _______.
    /   \     |   ____||   _  \      /  __  \     |           | /  __  \   /  __  \  |  |        /       |
   /  ^  \    |  |__   |  |_)  |    |  |  |  |    `---|  |----`|  |  |  | |  |  |  | |  |       |   (----`
  /  /_\  \   |   __|  |      /     |  |  |  |        |  |     |  |  |  | |  |  |  | |  |        \   \    
 /  _____  \  |  |____ |  |\  \----.|  `--'  |        |  |     |  `--'  | |  `--'  | |  `----.----)   |   
/__/     \__\ |_______|| _| `._____| \______/         |__|      \______/   \______/  |_______|_______/   """)
    print("----------------------------------------------------------------------------------------------------------\n")
